...
itext = {
    'en': {
        ...
        'rec-help': 'To record, send message as: record [site id] [patient id] [patient phone # (optional)]',
        ...
        'cannot-parse-enroll': 'Did not understand; send message as: enroll [site id] [patient id] [patient phone #] [desired contact time (HHMM)] [language (EN/SW/LUO)]',
        'cannot-parse-record': 'Did not understand; send message as: record [site id] [patient id] [patient phone # (optional)]',
        ...
        'patid-already-registered': 'This patient ID has already been registered on another phone',
